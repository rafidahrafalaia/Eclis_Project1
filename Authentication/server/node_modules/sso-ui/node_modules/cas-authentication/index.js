...
function CASAuthentication(options) {
    ...
    console.log(this.cas_host,"host");
    ...
    console.log("sessname",this.session_name);
...
CASAuthentication.prototype._handle = function(req, res, next, authType) {
    ...
    // Otherwise, redirect the user to the CAS login.
        ...
        console.log("handle4")
        console.log("mysession",req.session[ this.session_name ]);
...
CASAuthentication.prototype._login = function(req, res, next) {
    ...
    console.log(req.session.cas_return_to,"casreturn");
	if (this.renew) {
        console.log("test");
		var query = {
        ...
        response.on('end', function() {
            this._validate(body, function(err, user, attributes) {
                if (err) {
                    ...
                    console.log("insersession")
                    req.session[ this.session_name ] = user;
                    console.log(req.session[ this.session_name ],"name")
                    if (this.session_info) {
                        req.session[ this.session_info ] = attributes || {};
                        console.log(req.session[ this.session_info ],"iinfo");
                    }
                    res.redirect(req.session.cas_return_to);
                }
            }.bind(this));
