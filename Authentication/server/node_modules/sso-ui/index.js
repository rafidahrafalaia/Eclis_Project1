...
function SSO(options) {
    ...
    console.log(session_sso,"sessionsso");
    /**
    ...
    this.middleware = function(req, res, next) {
        console.log("middleware",req.session[session_sso]);
        if (req.session[session_sso]) {
            ...
            req.session[ 'sso_user' ]=user;
            console.log("test1 ",req[session_sso]);
        } else {
            console.log("test2 ",req[session_sso]);
